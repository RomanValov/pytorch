...
BUILD_TYPE       = dev
BUILD_PROGRESS   = auto
BUILD_ARGS       = --build-arg BASE_DEVEL=$(BASE_DEVEL) --build-arg BASE_IMAGE=$(BASE_IMAGE) --build-arg PYTHON_VERSION=$(PYTHON_VERSION) --build-arg INSTALL_CHANNEL=$(INSTALL_CHANNEL) --build-arg CUDA_TOOLKIT_VERSION=$(CUDA_TOOLKIT_VERSION)
